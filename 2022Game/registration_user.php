...
<head>
    ...
    <link rel="stylesheet" href="style_registration_users.css" type="text/css">
</head>
                    ...
                    <div class="modalBlock-content">
                        <div class="form-group" style="text-align: center">
                            ...
                            <form method="POST" action="registration.php">
                                <div class="form-group optionsDepartment">
                                    <input type="text" class="form-control" id="inputLogin" name="login" placeholder="Логин">
                                    <br />

                                    <input type="text" class="form-control" id="inputPassword" name="pass" placeholder="Пароль">
                                    <br />
